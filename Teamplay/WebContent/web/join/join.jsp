		...
		<table class="table" border="0" width="500" height="550">
			<tbody><tr>
				...
				<td width="80%" align="left" class="send">
					...
					<input type="button" name="idcheck" value="중복체크" class="btn btn-default" onclick="idFind()">
				</td>
			...
			<tr>
				...
				<td width="80%" align="left">
					...
					<input type="button" value="우편번호 검색" name="postfind" onclick="postFind()" class="btn btn-default" >
