...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new daum.maps.LatLng(37.553187, 126.936783), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };  
...
function getListItem(index, places) {
   ...
   var pTitle = places.title.replace("파파이스", "BREAK&BURGER");
...
function displayInfowindow(marker,title) {
   var pTitle = title.replace("파파이스", "BREAK&BURGER");
    var content = '<div style="padding:5px;z-index:1;">' + pTitle + '</div>';
